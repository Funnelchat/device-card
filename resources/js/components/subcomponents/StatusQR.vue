<template>
  <div class="flex items-center justify-center">
    <div class="qr-text p-8">
      ...
      <p class="text-gray-600 pt-2 pb-3">
        {{
          __("To start using Funnelchat, you must link your WhatsApp number")
        }}:
      </p>

      <div class="text-gray-600">
        <ol class="ml-4">
          <li class="pb-2">1. {{ __("Open WhatsApp on your phone") }}.</li>
          <li class="pb-2">
            2. {{ __("Touch Menu") }}
    ...
    <img v-if="status.qrCode && !suspended_qr" :src="status.qrCode" alt />
    <div
      v-else
    ...
    >
      ...
      <span class="text-sm text-gray-800"
        >{{ __("Your code has expired, click here to get a new one") }}.
      </span>
    </div>
  </div>
</template>
<script>
export default {
  props: ["status", "suspended_qr", "startInterval"],
  methods: {
    reloadQr() {
